...
$localIP = Get-NetIPAddress -AddressFamily IPv4 | Where-Object {$_.InterfaceAlias -notlike 'Loopback' -and $_.InterfaceOperationalStatus -eq 'Up'} | Select-Object -ExpandProperty IPAddress
